...
CREATE TABLE IF NOT EXISTS `avion` (
  ...
  `modelo_id_modelo` int(11) DEFAULT NULL,
  `piloto_id_piloto` int(11) DEFAULT NULL,
  `hangar_id_hangar` int(11) DEFAULT NULL,
  `puerta_abordaje_id_puerta_abordaje` int(11) DEFAULT NULL,
  `tripulacion_id_tripulacion` int(11) DEFAULT NULL,
  `lista_pasajero_id_lista_pasajero` int(11) DEFAULT NULL,
  ...
  CONSTRAINT `fkcodavion_piloto` FOREIGN KEY (`piloto_id_piloto`) REFERENCES `personas` (`id_persona`),
...
REPLACE INTO `avion` (`cod_avion`, `Caracteristica`, `modelo_id_modelo`, `piloto_id_piloto`, `hangar_id_hangar`, `puerta_abordaje_id_puerta_abordaje`, `tripulacion_id_tripulacion`, `lista_pasajero_id_lista_pasajero`) VALUES
	(1, 'Veloz', 1, 1, 1, NULL, NULL, 1),
	(2, 'Intermedio', 4, 2, 4, NULL, NULL, 2);
...
REPLACE INTO `estado_vuelo` (`id_Estado_Vuelo`, `descripcion`) VALUES
	(1, 'Arribando'),
	(2, 'Saliendo'),
	(3, 'Retrasado'),
	(4, 'Cancelado'),
...
CREATE TABLE IF NOT EXISTS `hangar` (
  ...
  `canti_aviones` decimal(10,0) NOT NULL,
  PRIMARY KEY (`id_hangar`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8;

/*!40000 ALTER TABLE `hangar` DISABLE KEYS */;
REPLACE INTO `hangar` (`id_hangar`, `ubicacion`, `canti_aviones`) VALUES
	(1, 'Norte', 10),
	(2, 'Sur', 15),
	(3, 'Este', 5),
	(4, 'Oeste', 20);
...
CREATE TABLE IF NOT EXISTS `lista_pasajero` (
  ...
  `pasajero` int(11) DEFAULT NULL,
  PRIMARY KEY (`id_lista_pasajero`),
  KEY `fklistpas_pasajero` (`pasajero`),
  CONSTRAINT `fklistpas_pasajero` FOREIGN KEY (`pasajero`) REFERENCES `personas` (`id_persona`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;

/*!40000 ALTER TABLE `lista_pasajero` DISABLE KEYS */;
REPLACE INTO `lista_pasajero` (`id_lista_pasajero`, `cantidad_pasajeros`, `pasajero`) VALUES
	(1, 1000, NULL),
	(2, 2000, NULL),
	(3, 3000, NULL);
...
REPLACE INTO `modelo` (`id_modelo`, `nom_modelo`, `capacidad`) VALUES
	(1, 'Boeing 747', '10000'),
	(2, 'Airbus A320', '8000'),
	(3, 'Tu-204', '7000'),
	(4, 'Ilyushin ll-96', '5500');
...
REPLACE INTO `ruta` (`cod_ruta`, `valor`, `ciudad_id_ciudad`) VALUES
	(442, '9 horas', 3),
	(521, '4 horas', 1),
	(998, '14 horas', 4);
...
CREATE TABLE IF NOT EXISTS `vuelos` (
  ...
  `id_piloto_designado` int(11) DEFAULT NULL,
  ...
  KEY `fkvuelos_piloto` (`id_piloto_designado`),
  CONSTRAINT `fkvuelos_avion` FOREIGN KEY (`avion_id_avion`) REFERENCES `modelo` (`id_modelo`),
  ...
  CONSTRAINT `fkvuelos_piloto` FOREIGN KEY (`id_piloto_designado`) REFERENCES `personas` (`id_persona`),
  CONSTRAINT `fkvuelos_ruta` FOREIGN KEY (`ruta_id_ruta`) REFERENCES `ruta` (`cod_ruta`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8;

/*!40000 ALTER TABLE `vuelos` DISABLE KEYS */;
REPLACE INTO `vuelos` (`cod_vuelos`, `fecha_hora`, `id_piloto_designado`, `avion_id_avion`, `ruta_id_ruta`, `estadov_id_estadov`, `id_ciudad`) VALUES
	(1, '2019-05-29 20:00:00', 1, 1, 442, 2, 3),
	(2, '2019-06-28 22:00:00', 2, 4, 521, 1, 1),
	(3, '2019-09-25 19:00:00', 1, 2, 998, 5, 4),
	(4, '2019-10-22 09:00:00', 2, 3, 521, 3, 2),
	(5, '2019-08-22 10:00:00', 1, 1, 442, 4, 3);
